...
\begin{table}[H]
	...
	\end{tabular}
\end{table}
% End LaTeX Table for Replacement Exp.:
\newpage
% LaTeX Metrics Table for Expansion Exp.: - Metric: val_f1_score - Target Gen Group: 5
...
\end{table}
% End LaTeX Table for Expansion Exp.:
% LaTeX Metrics Table for Replacement Exp.: - Metric: val_f1_score - Target Gen Group: 5
...
% End LaTeX Table for Replacement Exp.:
\newpage
% LaTeX Metrics Table for Expansion Exp.: - Metric: val_f1_score - Target Gen Group: 7
...
\end{table}
% End LaTeX Table for Expansion Exp.:
% LaTeX Metrics Table for Replacement Exp.: - Metric: val_f1_score - Target Gen Group: 7
...
\end{table}
% End LaTeX Table for Expansion Exp.:
% LaTeX Metrics Table for Replacement Exp.: - Metric: val_f1_score - Target Gen Group: 10
...
% End LaTeX Table for Replacement Exp.:
\newpage
\subsubsection{Dataset: FASHION, Architecture: VANILLA GAN}
% LaTeX Metrics Table for Expansion Exp.: - Metric: val_f1_score
% LaTeX Metrics Table for Expansion Exp.: - Metric: val_f1_score - Target Gen Group: 10
\noindent\textbf{Expansion Exp.:}
\begin{figure}[htbp]
