...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|}
		\hline
		Generators & Chi-square \((\times 10^7)\) & KL-Diverse \\ \hline
		1 & $1.27$ & $0.57$ \\
		2 & $1.38$ & $0.42$ \\
		3 & $3.15$ & $0.71$ \\
		4 & $0.39$ & $0.28$ \\
		...
		\hline
	\end{tabular}	
	\caption{Results from Ghosh et al. \cite{ghosh2018madgan}. Original caption: \textit{Synthetic experiment with different number of MAD-GAN generators as Figure 5.}}
\end{table}
