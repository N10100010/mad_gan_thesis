...
%the following shall be moved to the experiments section
%Drawing parallels with successful applications of similar GAN architectures on simpler datasets like MNIST and Fashion-MNIST (28x28 pixels, grayscale), a strategic decision was made to evaluate the CMADGAN concept under conditions more amenable to stable training and analysis. To this end, the CIFAR-10 dataset was **modified** for subsequent experiments: images were converted to grayscale and resized to 28x28 pixels.
