...
\newpage
\subsubsection[Question 1]{Question 1: Comparison of FID- and Inception Scores}     \label{exp_results_ans_q1}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        ...
        \hline
    \end{tabular}
    \caption{FID and IS results for GAN models on MNIST, comparing single-generator (DCGAN, cGAN) and multi-generator (MADGAN, cMADGAN; K=3-10) approaches. Baseline created from training datasets. Baseline created using images from the training set. The best results are marked as bold (excluding the baseline).}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        ...
        \hline
    \end{tabular}
    \caption{FID and IS results for GAN models on Fashion-MNIST, comparing single-generator (DCGAN, cGAN) and multi-generator (MADGAN, cMADGAN; K=3-10) approaches. Baseline created using images from the training set. The best results are marked as bold (excluding the baseline).}
...
\noindent
All graphs in the corresponding figure show rapid convergence and stable training within 15 epochs. After 20 epochs, only small fluctuations in the results can be observed for both TDA and MADGAN GDA. With a small spread of $0.0017$, all ratios for TDA resulted in an F1 score on the validation set of over $0.99$. This supports the conclusion that, for TDA, replacing training images for a classifier with modified images results in minimal negative impact on performance, as measured on the validation set using the F1 score. It is important to emphasize that the best, median, and average scores all surpassed the baseline, indicating that the augmentation improved classifier performance on average.
...
\newpage
\subsubsection[Question 3]{Question 3: MADGAN GDA vs. Deep Convolutional/Conditional GAN GDA} \label{exp_results_ans_q3}
...
\newpage
\subsubsection[Question 4]{Question 4: MADGAN GDA vs. cMADGAN GDA Performance}      \label{exp_results_ans_q4}
...
\subsubsection[Question 5]{Question 5: Effect of increasing the Generators}            \label{exp_results_ans_q5}
