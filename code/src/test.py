...
def plot_scores(data):
    ...
    plt.savefig("/home/stud/n/nr063/mounted_home/mad_gan_thesis/code/experiments/CIFAR_MADGAN_MODELS_PROTOTYPES/2025-03-20_CIFAR_MADGAN_Experiment___big__latent_2048_3_gen/scores/FID.png")
    ...
    plt.tight_layout()
    plt.savefig("/home/stud/n/nr063/mounted_home/mad_gan_thesis/code/experiments/CIFAR_MADGAN_MODELS_PROTOTYPES/2025-03-20_CIFAR_MADGAN_Experiment___big__latent_2048_3_gen/scores/IS.png")

    breakpoint()



with open("/home/stud/n/nr063/mounted_home/mad_gan_thesis/code/experiments/CIFAR_MADGAN_MODELS_PROTOTYPES/2025-03-20_CIFAR_MADGAN_Experiment___big__latent_2048_3_gen/scores/metrics.json", "r") as f:
    data = json.load(f)
