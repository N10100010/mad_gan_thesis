...
experiments = [
    ...
    CondGAN_GenerativeCreationExperiment(
        ...
        experiment_class=ConditionalGAN_Experiment,
        experiment_path="experiments/CONDITIONAL_GAN_MODELS/2025-03-17_MNIST_ConditionalGAN_Experiment_latent_256",
        latent_point_generator=tf.random.normal,
        n_images_per_class=10_000,
        save_raw_image=True,
    ...
    CondGAN_GenerativeCreationExperiment(
        ...
        experiment_class=ConditionalGAN_Experiment,
        experiment_path="experiments/CONDITIONAL_GAN_MODELS/2025-03-17_FASHION_ConditionalGAN_Experiment_latent_256",
        latent_point_generator=tf.random.normal,
        n_images_per_class=10_000,
        save_raw_image=True,
        discriminator_func=define_discriminator_mnists,
    ...
    CondGAN_GenerativeCreationExperiment(
        name="FASHION_CONDITIONAL_DataCreation_not_flipped",
        experiment_class=ConditionalGAN_Experiment,
        experiment_path="experiments/CONDITIONAL_GAN_MODELS/2025-03-17_FASHION_ConditionalGAN_Experiment_latent_256_not_flipped",
        latent_point_generator=tf.random.normal,
        n_images_per_class=10_000,
        save_raw_image=True,
        discriminator_func=define_discriminator_mnists,
