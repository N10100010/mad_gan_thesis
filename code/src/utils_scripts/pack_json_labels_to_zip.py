...
output_zip = "./fashion_madgan_data_creation_jsons.zip"

# Collect JSON files from folders containing "_DataCreation_"
json_files = []
for root, dirs, files in os.walk(experiments_folder):
    if "2025-02-27_MADGAN_FASHIONMNIST_7_GEN_DataCreation_S" in os.path.basename(root):  #  "_DataCreation_" in os.path.basename(root):
