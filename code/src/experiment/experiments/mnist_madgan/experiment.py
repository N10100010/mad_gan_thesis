...
class MNIST_MADGAN_Experiment(BaseExperiment): 
    ...
    def _initialize_models(self):
        ...
        self.generators = define_generators(self.n_gen, self.latent_dim, class_labels=self.unique_labels)
        ...
        self.madgan.compile(
            ...
            g_optimizer=[tf.optimizers.Adam(learning_rate=1e-4, beta_1=0.5) for _ in range(self.n_gen)],
